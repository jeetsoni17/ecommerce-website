...
--
-- Table structure for table `abill`
--
...
--
-- Dumping data for table `apayment`
--

INSERT INTO `apayment` (`payid`, `uid`, `amount`, `date`) VALUES
...
INSERT INTO `aproducts` (`pid`, `name`, `type`, `qty`, `measure`, `cost`, `img`) VALUES
...
INSERT INTO `ausers` (`userid`, `username`, `phone`, `email`, `password`, `walletamt`, `address`, `pin`) VALUES
(0, 'admin', '1234567890', 'eshasanghavi1@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 10000, NULL, NULL),
(4, 'Esha', '7738235101', 'eshasanghavi17@gmail.com', '8a7a7430eaaf3b93590992e5ca945f1e', 8944, '9A 403, Alica Nagar, Lokhandwala Township, Akurli Road, Kandivali East, Mumbai', '400101'),
(6, 'Diva', '9323982858', 'divasanghavi@gmail.com', '8a7a7430eaaf3b93590992e5ca945f1e', 10000, NULL, NULL);
...
--
-- Indexes for table `apayment`
--
ALTER TABLE `apayment`
...
--
-- AUTO_INCREMENT for table `apayment`
--
ALTER TABLE `apayment`
...
--
-- Constraints for table `acart`
--
ALTER TABLE `acart`
  ADD CONSTRAINT `acart_ibfk_1` FOREIGN KEY (`pid`) REFERENCES `aproducts` (`pid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `acart_ibfk_2` FOREIGN KEY (`uid`) REFERENCES `ausers` (`userid`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Constraints for table `apayment`
--
ALTER TABLE `apayment`
  ADD CONSTRAINT `apayment_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `ausers` (`userid`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
